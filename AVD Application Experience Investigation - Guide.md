...
This workbook helps investigate Azure Virtual Desktop (AVD) connection, transport, logon, session-host, graphics, resource-discovery, scaling, and application-impact issues. Use it for a single-user complaint, a host-pool trend, a time-based incident, or a post-change validation.
